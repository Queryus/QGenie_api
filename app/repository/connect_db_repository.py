...
def test_db_connection(driver_module: Any, **kwargs: Any) -> TestConnectionResult:
    """
    ...
    try:
        ...
        return TestConnectionResult(is_successful=True, code=CommonCode.SUCCESS_DB_CONNECT)
